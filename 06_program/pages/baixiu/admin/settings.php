<?php 
  ...
  if(!empty($_POST)){ // 添加/更新网站设置
    ...
    // 'UPDATE options SET value="值" WHERE `key`="site_logo"';
    ...
    <div class="container-fluid">
      ...
      <form action="/admin/settings.php" method="post" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="site_logo" name="site_logo" type="hidden" value="<?php echo $rows[1]['value']; ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <textarea id="site_description" name="site_description" class="form-control" placeholder="站点描述" cols="30" rows="6"><?php echo $rows[3]['value']; ?>
            </textarea>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <div class="checkbox">
              <label><input id="comment_status" name="comment_status" type="checkbox" <?php if( $rows[6]['value'] ==1 ){ ?> checked <?php } ?>  value="1">开启评论功能
              </label>
            </div>
            <div class="checkbox">
              <label><input id="comment_reviewed" name="comment_reviewed" type="checkbox" <?php if( $rows[7]['value'] ==1 ){ ?> checked <?php } ?>  value="1">评论必须经人工批准
              </label>
            </div>
          </div>
        </div>
